...
$I->wantTo('Retrieve created alert '.$alertId);
$I->sendGET('alerts/'.$alertId);
$I->seeResponseCodeIs(200);
$I->seeResponseContains('{"Id":');
$I->seeResponseContains('"owner":');  
$I->seeResponseContains('"details":');
$I->seeResponseContains('"Reported":');
$I->seeResponseContains('"Symptom":'.$symptomId);

$I->wantTo('Retrieve alerts ');
$I->sendGET('alerts/');
$I->seeResponseCodeIs(200);
...
$I->wantTo('Update created Alert '.$alertId);
$I->sendPUT('alerts/'.$alertId,'{"notes":"updated"}');
$I->seeResponseCodeIs(200);
$I->seeResponseContains('"Notes":"updated"');


$I->wantTo('Update created Alert detail '.$alertId);
$I->sendPUT('alerts/'.$alertId,'{"details":[{"Symptom":'.$symptomId2.', "Element":'.$elementId.'}]}');
$I->seeResponseCodeIs(200);
...
$I->wantTo('Retrieve files from alert '.$alertId);
$I->sendGET('alerts/'.$alertId.'/files');
$I->seeResponseCodeIs(200);
$I->seeResponseContains('{"Id":');
