...
$I->sendPOST('symptoms/'.$symptomId.'/elements',''.$elementId.'');
$response = $I->grabResponse();
$I->seeResponseCodeIs(200);
...
$I->wantTo('Retrieve assigned element ');
$I->sendGET('symptoms/'.$symptomId.'/elements');
$I->seeResponseCodeIs(200);
$I->seeResponseContains('"total":1');



$I->wantTo('Unassgngn elements '.$elementId);
$I->sendDELETE('symptoms/'.$symptomId.'/elements/'.$elementId);
$I->seeResponseCodeIs(200);
