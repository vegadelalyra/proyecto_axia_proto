...
const WaitRoomHero = () => {
  ...
  return (
    <div className='table__header--waitroom'>
      <picture className='table__header--hero-container'>
        <svg
      ...
      <picture className='table__header--logo'>
        <img
          src={`/src/assets/images/logo_${isDarkMode ? 'dark' : 'light'}.png`}
          alt='AXIA Servicios'
        />
      </picture>
    </div>
